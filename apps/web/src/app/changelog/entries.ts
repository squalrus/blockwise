...
export const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  { version: "0.71.0", date: "2026-08-21", summary: "Monitoring tab for super admins -- error tracking and request volume/latency charts, rolled on our own Postgres tables rather than a third-party service; also a custom on-brand 404 page" },
