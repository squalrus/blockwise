...
// Marketing landing page. This route supplies its own nav and footer (see
// SiteChrome.tsx) instead of the app-wide AccountNav/Footer, and its palette
// is the fixed set of hex values from the Spored Homepage design rather than
// the app's light/dark CSS variables -- this is a standalone landing page,
// not a themed app screen.
const INK = "#2B1B12";
const CREAM = "#FBF2E4";
const ORANGE = "#E8542A";
const AMBER = "#F2A93B";
    ...
    <div className="min-h-screen overflow-x-hidden font-sans" style={{ background: CREAM }}>
      ...
      <div className="sticky top-0 z-50 backdrop-blur-sm" style={{ background: "rgba(43,27,18,0.96)" }}>
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-4">
          ...
          <div className="flex items-center gap-2.5">
            <a href="/login" className="hidden text-sm font-bold md:inline" style={{ color: "#E4D3B8" }}>
              Sign in
            </a>
            <a
              href="/signup"
      ...
      <div className="relative overflow-hidden px-5 pt-12 pb-10 md:px-6 md:pt-[90px] md:pb-[60px]">
        ...
        <div className="relative mx-auto max-w-6xl text-center">
          ...
          <div className="mt-[30px] flex flex-wrap justify-center gap-3.5">
            ...
            <PillButton href="/neighborhoods" variant="outline-dark">
      ...
      <div className="relative overflow-hidden px-5 py-14 text-center md:px-6 md:py-[90px]" style={{ background: INK }}>
        ...
        <div className="mt-[26px] flex flex-wrap justify-center gap-3.5">
          ...
          <PillButton href="/neighborhoods" variant="outline-light">
