...
export async function generateMetadata({
  ...
  return { alternates: { canonical: `/neighborhoods/${slug}/today` } };
}
...
// BACKLOG.md Ref 27: Today tab -- events happening today (in progress or
// later today, not just this exact instant) plus businesses/POIs whose
// cached hours say they're open right now. No longer the default route --
// Spore feed (page.tsx) took that slot, matching /account's tab order.
