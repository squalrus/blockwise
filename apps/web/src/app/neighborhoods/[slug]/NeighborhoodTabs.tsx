...
//
// Renders via the shared TabNav (also used by the account and location
// pages) with getHref, so tab switches stay client-side navigations --
// Next.js prefetches each tab's RSC payload in the background and swaps
// content in place instead of doing a full browser page load, which is both
// faster and avoids a blank-page flash. TabNav's Link uses scroll={false},
// which additionally skips the router's default scroll-to-top on
