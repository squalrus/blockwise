...
## Keeping Terms/Privacy/FAQ current
...
[apps/marketing/src/app/faq/page.tsx](./apps/marketing/src/app/faq/page.tsx) describes current product behavior too (what Spored is, pricing, how check-ins/points/badges/events/business claims work). Whenever a change alters any of that -- a new user-facing feature, a pricing change, a change to how an existing flow works -- check the matching question on the FAQ page and update it (and bump its "Last updated" date) as part of that same change.
